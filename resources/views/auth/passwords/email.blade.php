...
@section('title') Forgot your password | Jot - The SPA App @endsection
...
@section('content')
    <div class="min-h-full py-8 mx-0 flex justify-center items-center bg-gray-300">
        <div class="w-100 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <h2 class="text-blue-300 pt-2">Enter your email to reset password</h2>

            <form class="pt-6" method="POST" action="{{ route('password.email')  }}">
                @csrf
