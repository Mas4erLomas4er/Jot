<template>
    <div class="bg-gray-100 w-48 h-screen border-r-2 border-gray-300 pl-6">
        <nav class="pt-4 tracking-wide">
            <router-link to="/">
            ...
            <div>
                <p class="pt-12 text-gray-400 text-xs uppercase font-bold">Create</p>

                <router-link to="/contacts/create" class="text-sm flex items-center py-2 hover:text-blue-600 transition-all">
                    ...
                    <p class="pl-3">Add new</p>
                </router-link>
            </div>

            <div>
                <p class="pt-12 text-gray-400 text-xs uppercase font-bold">General</p>

                <router-link to="/contacts" class="text-sm flex items-center py-2 hover:text-blue-600 transition-all">
                ...
                <router-link to="/birthdays" class="text-sm flex items-center py-2 hover:text-blue-600 transition-all">
                    <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                    ...
                    <p class="pl-3 mt-1">Birthday</p>
                </router-link>
            </div>

            <div>
                <p class="pt-12 text-gray-400 text-xs uppercase font-bold">Settings</p>

                <a class="text-sm flex items-center py-2 hover:text-blue-600 transition-all cursor-pointer" @click="logout">
                    <svg viewBox="0 0 24 24" class="fill-current text-blue-600 w-5 h-5">
                        <path
